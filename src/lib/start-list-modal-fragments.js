...
export const build_start_list_modal_list_html = (startListInput, eventId = '', startListTotal = null) => {
  ...
  const athletes = mainList.map((athlete) => {
    ...
    return `
            <li class="flex items-center justify-between px-2 py-4 lg:px-4 bg-surface-container-low/40 hover:bg-surface-container-high transition-all duration-200 rounded-lg group start-list-athlete">
