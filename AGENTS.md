...
- Node scripts in `bin/` generate SEO/data artifacts and cache media assets.
...
- `public/sitemap.xml` is generated by `bin/build-sitemap.mjs`.
...
- Build structured data files: `node bin/build-structured-data.mjs [events-dir] [output-dir] [site-url]`.
- Build sitemap: `node bin/build-sitemap.mjs [events-dir] [output-file] [site-url]`.
