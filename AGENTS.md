...
- `public/` contains static assets and source-like event data consumed at build time.
...
- Season/event JSON from `public/events/` is loaded during build (not fetched via runtime AJAX for core page data).
